...
public class CbcrDoc extends TieDoc {
	...
	public TieDoc getTieDocRecord() {
		return tieDocRecord;
	}

	public void setTieDocRecord(TieDoc tieDocRecord) {
	...
	public String toString() {
		return "CbcrDoc [cbcrTable1List=" + cbcrTable1List + ", cbcrTable2List=" + cbcrTable2List + ", cbcrTable3List="
				+ cbcrTable3List + ", tieDocRecord=" + tieDocRecord + "]";
	}

							...
							<tbody>
								...
								<tr height="34"
									...
									<td rowspan="2" class="xl76" width="84"
										style="border-top: none; width: 63pt">Accumulated
										Earnings</td>
									<td rowspan="2" class="xl76" width="86"
						...
						<table style="width: 100%">
							...
							<tr>
								...
								<td class="x00l66" rows="4" cols="180" id="To">Please
									...
									consider necessary or that would facilitate the understanding
									of the compulsory information provided in the
									country-by-country report.</td>
